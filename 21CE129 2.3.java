//This program is created by moxshang shah 21CE129
...
{	//Declaration of variables
	...
	Account(String i)//parameterized constructer
	{
		id = i;
		balance = 300;
	}
	...
	void withdraw()//Method of withdraw
	{
		int temp;
	...
	void moneyTransfer(ArrayList ar)//Method of money transfer
	{
		int temp;
		String id;
		Scanner sc = new Scanner(System.in);
	...
	void Create(ArrayList arr) //Method for creating an account	
      {
		String str;
		Scanner sc = new Scanner(System.in);
	...
	void delete(ArrayList arr)//Method for deleting an account
	{
		String str;
		Scanner sc = new Scanner(System.in);
		Account ac = null;
